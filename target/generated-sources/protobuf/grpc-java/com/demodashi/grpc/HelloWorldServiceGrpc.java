...
public final class HelloWorldServiceGrpc {
  ...
  private static volatile io.grpc.MethodDescriptor<com.demodashi.grpc.HelloWorld.NameRequest,
      com.demodashi.grpc.HelloWorld.EchoResponse> getWelcomeMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "welcome",
      requestType = com.demodashi.grpc.HelloWorld.NameRequest.class,
      responseType = com.demodashi.grpc.HelloWorld.EchoResponse.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<com.demodashi.grpc.HelloWorld.NameRequest,
      com.demodashi.grpc.HelloWorld.EchoResponse> getWelcomeMethod() {
    io.grpc.MethodDescriptor<com.demodashi.grpc.HelloWorld.NameRequest, com.demodashi.grpc.HelloWorld.EchoResponse> getWelcomeMethod;
    if ((getWelcomeMethod = HelloWorldServiceGrpc.getWelcomeMethod) == null) {
      synchronized (HelloWorldServiceGrpc.class) {
        if ((getWelcomeMethod = HelloWorldServiceGrpc.getWelcomeMethod) == null) {
          HelloWorldServiceGrpc.getWelcomeMethod = getWelcomeMethod = 
              io.grpc.MethodDescriptor.<com.demodashi.grpc.HelloWorld.NameRequest, com.demodashi.grpc.HelloWorld.EchoResponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(
                  "HelloWorldService", "welcome"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.demodashi.grpc.HelloWorld.NameRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.demodashi.grpc.HelloWorld.EchoResponse.getDefaultInstance()))
                  .setSchemaDescriptor(new HelloWorldServiceMethodDescriptorSupplier("welcome"))
                  .build();
          }
        }
     }
  ...
  public static abstract class HelloWorldServiceImplBase implements io.grpc.BindableService {
    ...
    /**
     */
    public void welcome(com.demodashi.grpc.HelloWorld.NameRequest request,
        io.grpc.stub.StreamObserver<com.demodashi.grpc.HelloWorld.EchoResponse> responseObserver) {
    ...
    @java.lang.Override public final io.grpc.ServerServiceDefinition bindService() {
      return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
          .addMethod(
            ...
            asyncUnaryCall(
              new MethodHandlers<
                com.demodashi.grpc.HelloWorld.NameRequest,
                com.demodashi.grpc.HelloWorld.EchoResponse>(
  ...
  public static final class HelloWorldServiceBlockingStub extends io.grpc.stub.AbstractStub<HelloWorldServiceBlockingStub> {
    ...
    /**
     */
    public com.demodashi.grpc.HelloWorld.EchoResponse welcome(com.demodashi.grpc.HelloWorld.NameRequest request) {
  ...
  public static final class HelloWorldServiceFutureStub extends io.grpc.stub.AbstractStub<HelloWorldServiceFutureStub> {
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<com.demodashi.grpc.HelloWorld.EchoResponse> welcome(
        com.demodashi.grpc.HelloWorld.NameRequest request) {
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_WELCOME:
          serviceImpl.welcome((com.demodashi.grpc.HelloWorld.NameRequest) request,
              (io.grpc.stub.StreamObserver<com.demodashi.grpc.HelloWorld.EchoResponse>) responseObserver);
          break;
        default:
  ...
  private static abstract class HelloWorldServiceBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return com.demodashi.grpc.HelloWorld.getDescriptor();
    }
